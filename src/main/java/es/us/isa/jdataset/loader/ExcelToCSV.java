...
public class ExcelToCSV {
    ...
    public void convertExcelToCSV(InputStream source, StringBuilder destination) throws IOException, IllegalArgumentException, InvalidFormatException
    {
        this.convertExcelToCSV(source, destination,ExcelToCSV.DEFAULT_SEPARATOR, ExcelToCSV.EXCEL_STYLE_ESCAPING);
    }

    public void convertExcelToCSV(StringBuilder destination) throws IOException, IllegalArgumentException
    {
        this.convertExcelToCSV( destination,ExcelToCSV.DEFAULT_SEPARATOR, ExcelToCSV.EXCEL_STYLE_ESCAPING);
    }

    public void convertExcelToCSV( StringBuilder destination,
                                  String separator, int formattingConvention)
                       throws  IOException,
        ...
        this.formattingConvention = formattingConvention;
            ...
            // Save the CSV file away using the newly constricted file name
            // and to the specified directory.
            this.saveCSVStringBuilder(destination);

    }

    public void convertExcelToCSV(InputStream source, StringBuilder destination,
                                  String separator, int formattingConvention)
                       throws  IOException,
                              IllegalArgumentException,
     ...
     * as a CSV file.
     *
     * @param bw An instance of the StringBuilder that encapsulates a handle
     *             referring to the CSV file.
     * @throws java.io.FileNotFoundException Thrown if the file cannot be found.
     * @throws java.io.IOException Thrown to indicate and error occurred in the
     *                             underylying file system.
     */
    private void saveCSVStringBuilder(StringBuilder bw)
                                     throws FileNotFoundException, IOException {
        ...
        try {
            ...
            System.out.println("Saving the CSV file [uploaded file] to a String");
            ...
            for(int i = 0; i < this.csvData.size(); i++) {
                ...
                // Once the line is built, write it away to the CSV file.
                bw.append(buffer.toString().trim());
